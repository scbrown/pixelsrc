...
| [Phase 17](./colored-grid-display.md) | **Colored Terminal Output** (`pxl show`, coordinate grids, alias management) | Obsolete (WONT-DO) |
| [Phase 18](./transforms.md) | **Sprite Transforms** (mirror, rotate, tile, outline, crop) | Complete |
| [Phase 19](./advanced-transforms.md) | **Advanced Texture Features** (palette cycling, color ramps, atlas export) | Complete |
...
| [DT: Draw](./drafting-table-draw.md) | **`pxl draw`** (coordinate-based sprite editing) | Complete |
