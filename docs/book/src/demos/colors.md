...
color-mix(in srgb, color1 50%, color2 50%) for equal blending.
...
<div class="demo-container" data-demo="color_mix_basic">
</div>

## Color Mix in OKLCH

color-mix(in oklch, ...) for perceptually uniform mixing.
...
<div class="demo-container" data-demo="color_mix_oklch">
</div>

## Color Mix for Highlights

Using color-mix to create highlight variations.
...
<div class="demo-container" data-demo="color_mix_highlight">
</div>

## Color Mix Sprite Rendering

Sprite using color-mix renders correctly.
...
<div class="demo-container" data-demo="color_mix_sprite">
</div>

## Short Hex Colors

3-character hex notation (#RGB) expands to full #RRGGBB.
...
<div class="demo-container" data-demo="hex_short">
</div>

## Full Hex Colors

6-character hex notation (#RRGGBB) for precise color specification.
...
<div class="demo-container" data-demo="hex_full">
</div>

## Hex with Alpha

8-character hex notation (#RRGGBBAA) for colors with transparency.
...
<div class="demo-container" data-demo="hex_alpha">
</div>

## Hex Color Sprite Rendering

Sprite using hex colors renders with expected dimensions.
...
<div class="demo-container" data-demo="hex_sprite">
</div>

## HSL Colors

hsl(hue, saturation%, lightness%) with hue in degrees.
...
<div class="demo-container" data-demo="hsl_basic">
</div>

## HSL Saturation Levels

Varying saturation from 0% (grayscale) to 100% (fully saturated).
...
<div class="demo-container" data-demo="hsl_saturation">
</div>

## HSL Lightness Levels

Varying lightness from dark (25%) to light (75%).
...
<div class="demo-container" data-demo="hsl_lightness">
</div>

## HSL Color Sprite Rendering

Sprite using HSL colors renders correctly.
...
<div class="demo-container" data-demo="hsl_sprite">
</div>

## HWB Colors

hwb(hue, whiteness%, blackness%) color specification.
...
<div class="demo-container" data-demo="hwb_basic">
</div>

## HWB Whiteness

Varying whiteness from 0% (pure hue) to 50% (tinted).
...
<div class="demo-container" data-demo="hwb_whiteness">
</div>

## HWB Blackness

Varying blackness from 0% (bright) to 50% (shaded).
...
<div class="demo-container" data-demo="hwb_blackness">
</div>

## HWB Color Sprite Rendering

Sprite using HWB colors renders correctly.
...
<div class="demo-container" data-demo="hwb_sprite">
</div>

## Named CSS Colors

Standard CSS named colors like "red", "green", "blue".
...
<div class="demo-container" data-demo="named_basic">
</div>

## Warm Named Colors

Warm-toned named colors: coral, orange, gold.
...
<div class="demo-container" data-demo="named_warm">
</div>

## Cool Named Colors

Cool-toned named colors: teal, cyan, aqua.
...
<div class="demo-container" data-demo="named_cool">
</div>

## Neutral Named Colors

Grayscale named colors: white, silver, gray.
...
<div class="demo-container" data-demo="named_neutral">
</div>

## Named Color Sprite Rendering

Sprite using named colors renders correctly.
...
<div class="demo-container" data-demo="named_sprite">
</div>
...
<div class="demo-container" data-demo="oklch_basic">
</div>

## OKLCH Lightness

Perceptually uniform lightness from 0.25 to 0.75.
...
<div class="demo-container" data-demo="oklch_lightness">
</div>

## OKLCH Chroma

Varying chroma (saturation) from 0 to 0.2.
...
<div class="demo-container" data-demo="oklch_chroma">
</div>

## OKLCH Color Sprite Rendering

Sprite using OKLCH colors renders correctly.
...
<div class="demo-container" data-demo="oklch_sprite">
</div>

## RGB Colors

rgb(r, g, b) function with integer values 0-255.
...
<div class="demo-container" data-demo="rgb_basic">
</div>

## RGBA with Alpha

rgba(r, g, b, a) function with alpha channel 0.0-1.0.
...
<div class="demo-container" data-demo="rgba_alpha">
</div>

## RGB Color Sprite Rendering

Sprite using RGB colors renders correctly.
...
<div class="demo-container" data-demo="rgb_sprite">
</div>
