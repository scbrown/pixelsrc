...
fn test_hsl_saturation() {
    ...
    let palette =
        palette_registry.get("hsl_saturation").expect("hsl_saturation palette should exist");
...
fn test_hsl_lightness() {
    ...
    let palette =
        palette_registry.get("hsl_lightness").expect("hsl_lightness palette should exist");
